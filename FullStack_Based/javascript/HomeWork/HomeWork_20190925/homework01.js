...
var arr = ["String","Number","boolean","object","null","undefined"];
...
var arr = [12,43,54,43];
var sum = arr[1]+arr[3];
console.log("数组中第1个元素和第3个元素的和为: "+sum);


//4. 定义一个二维数组（随便放些数据进去）？


var arr = [11,12,13,["1","12","42"],5];
...
3、如何读取和修改和删除对象中的值？  对象名.属性名    delete 对象名.属性名

4、什么时候会出现 undefined？变量 未赋值 的时候

5、什么是数组？如何创建数组？把同一类数据放到一起组成数组

6、如何获取和修改数组中的某一个值？用元素下标，arr[2] = 100
