...
// 26.	var x=’1’+2+3;x的值是(A)
// A、123  B、15  C、6  D、语句会报错


// 27.	向数组array追加一个元素10，正确的做法是(C)
// A、array.shift(10)
// B、array.unshift(10)
// C、array.push(10)
// D、array.slice(10)
...
// 28.	var arr = [31,13,234,54,87];arr.sort()；对数组arr进行遍历数组返回(B)
// A、13,31,54,87,234
// B、13,234,31,54,87
// C、234,87,54,31,13
// D、87,54,31,234,13
...
// 33.	var undefs= [];以下向数组添加元素的正确的是(B)
// A、a.pop(“zero”)
// B、a.push(“one”)
// C、a.join(“two”)
// D、a.shift(“three”)
