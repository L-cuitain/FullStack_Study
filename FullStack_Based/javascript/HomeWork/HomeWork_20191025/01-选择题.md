...
19、下面哪个选项实现了复制一个数组得到新数组，原数组保持不变（B）
...
20、var a = new Array(‘100’,’2111’,’41111’);
